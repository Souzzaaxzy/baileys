...
export const EVIDENCE_TYPE = Object.freeze({
    ...
    /** More messages inside a burst window than a human can type. */
 ...
 *
 *   - WEAK     1-8    observed alone, never actionable
 *   - MEDIUM   9-19   needs corroboration
 *   - STRONG   20-34  strong on its own, still needs another category
 *   - CRITICAL 35+    never emitted alone; always paired with corroboration
 *
 * The scale is calibrated so that BEHAVIOUR ALONE (capped by the EvidenceEngine)
 * tops out in the SUSPICIOUS band, while behaviour + persistence, or behaviour +
 * a repeated protocol contradiction, can reach CONFIRMED. See the confidence
 * section of README-ANTIBOT.md for the measured curve.
 *
...
export const EVIDENCE_CATALOG = Object.freeze({
    ...
    [EVIDENCE_TYPE.BURST_DENSITY]: {
        category: EVIDENCE_CATEGORY.BEHAVIOR,
        level: EVIDENCE_LEVEL.STRONG,
        weight: 18,
        usable: true,
        explanation: 'More messages in a burst window than a human can type.'
    },
