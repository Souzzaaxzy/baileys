...
export const makeMessagesSocket = (config) => {
    ...
    const relayMessage = async (jid, message, { messageId: msgId, participant, additionalAttributes, additionalNodes, useUserDevicesCache, useCachedGroupMetadata, addBizAttributes, statusJidList, recipientMode, recipientParticipants, experimentalPairwiseRetry, experimentalPayload }) => {
        ...
        const recipientRestriction = isRetryResend
            ? null
            : { options: { recipientMode, recipientParticipants } };
