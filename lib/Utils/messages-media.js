...
export const getHttpStream = async (url, options = {}) => {
    // Lia@Changes --- Honor `options.signal` on the media fetch.
    //
    // Sem repassar o signal, um `AbortController` do chamador nao tinha efeito:
    // o fetch ficava pendurado para sempre quando o servidor de midia aceitava a
    // conexao e nunca respondia (o handler do bot nunca terminava).
